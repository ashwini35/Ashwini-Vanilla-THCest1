...
public class BaseClass {
	...
	public final String Logintitle = "3DEXPERIENCE Platform";
	public final String FCStile = "3DPassport Control Center" ;
	@BeforeSuite
	...
	public static String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8080/job/Vanilla-Test-Mav/ws/Vanilla-HC-Test-1/ScreenShot/" + filename + "_"
				+ dateName + ".png";
